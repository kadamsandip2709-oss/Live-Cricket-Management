...
from .forms import MatchForm, MatchScoreForm
...
def add_player(request, team_id):
    ...
    # 🚫 prevent adding more players than allowed
...
def edit_team(request, team_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            team.wickets = team.total_players - 1  # auto set
            team.save()
...
def update_score(request, match_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            match.decide_winner()  # Auto-decide winner
